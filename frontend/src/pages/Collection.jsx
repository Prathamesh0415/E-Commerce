...
function Collection() {
  ...
  // FIX 1: Merged Filtering and Sorting into one logic block
  // This prevents the sort from being lost when you click a filter, 
  // and prevents the filter from being lost when you change sort order.
  const applyFilter = () => {
    ...
    // 4. Sort Logic (Applied AFTER filtering)
    switch (sortType) {
        case 'low-high':
        ...
        case 'high-low':
            ...
            break;
        default:
            // 'relevant' uses default order, no action needed
            break;
    }
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          ...
          <select onChange={(e) => setSortType(e.target.value)} className='border-2 border-gray-400 text-sm px-2'>
            {/* FIX 3: Fixed typo 'relavent' -> 'relevant' */}
