...
function Navbar() {
    ...
    // FIX 1: Added setCartItems to destructuring
    // Missing this causes a crash in the logout function
    const { setShowSearch, showSearch, getCartCount, navigate, token, setToken, setCartItems } = useContext(ShopContext)

    const logout = () => {
        navigate('/login') // Redirect to login page on logout usually feels smoother
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        {/* FIX 2: Changed absolute to fixed and added z-50 */}
        {/* This ensures the menu stays on screen even if the user has scrolled down */}
