...
function Navbar() {
    ...
    const { setShowSearch, showSearch, getCartCount, navigate, token, setToken } = useContext(ShopContext)
    ...
    const logout = () => {
        ...
        setToken('')
        setCartItems({})
       // navigate('/login') as setToken and setCartItems are asynchronous so they dont work instantly
    }
